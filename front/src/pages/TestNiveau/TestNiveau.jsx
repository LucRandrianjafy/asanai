...
import styles from "./TestNiveau.module.css";
...
const TestNiveau = () => {
  ...
  /* =========================================================
     ...
     Exemple :
     /adminit/test-niveau/1
       => [1]

     /adminit/test-niveau/1,2,3
       => [1, 2, 3]
  ========================================================= */
  ...
  const isMultipleMode = testIds.length > 1;
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      if (!testId) {
        setError(
          "ID du test de niveau introuvable."
        );
  ...
  const handleAddQuestion = () => {
    ...
    if (testIds.length === 0) {
      alert(
        "Aucun test de niveau sélectionné."
      );
  ...
  const handleSaveMultipleQuestions =
    async () => {
      ...
      try {
        ...
        alert(
          `${qcm.questions.length} question(s) créée(s) pour ${testIds.length} test(s).`
        );
          ...
          >
            ...
            >
              ...
              <p>
                ...
                {isMultipleMode
                  ? "Créez les mêmes questions pour plusieurs tests de niveau."
                  : "Consultez et gérez les questions, réponses, points et durées du test."}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {isMultipleMode
                    ? `${testIds.length} tests sélectionnés`
                    : qcm.statut}
